...
import ViewportSeeReportForm from '../../../platform/ui/src/components/content/viewportSeeReportForm/ViewportSeeReportForm';

const MINIMUM_SIZE = 100;
const DEFAULT_SIZE = 512;
const MAX_TEXTURE_SIZE = 10000;

const CornerstoneViewportSeeReportForm = ({ onClose, activeViewportIndex }) => {
...
CornerstoneViewportSeeReportForm.propTypes = {
  onClose: PropTypes.func,
  activeViewportIndex: PropTypes.number.isRequired,
};

export default CornerstoneViewportSeeReportForm;
